...
console.log(process.env.OPENSHIFT_NODEJS_IP || "127.0.0.1" + " " + process.env.OPENSHIFT_NODEJS_PORT || 80);
httpServer.listen(process.env.OPENSHIFT_NODEJS_IP || "127.0.0.1", process.env.OPENSHIFT_NODEJS_PORT || 80);